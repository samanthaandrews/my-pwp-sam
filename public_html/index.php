				...
				<div class="row">
					...
					<div class="col-sm-12 col-lg-8">
						<div class="row d-flex justify-content-end">
							...
							<a data-fancybox="gallery" href="images/pdf/tessa-nickerson-branding.pdf"><img
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-sm-12 col-md-12 col-lg-6 form">
						<form class="form pt-2" role="form" id="my-pwp-form" action="php/mailer.php" method="post">
